...
public class GlusterDebugFileSystem extends GlusterVolume{
    ...
    public void setConf(Configuration conf) {
        GlusterDebugFileSystem.logMachine("setConf of the GlusterDebugFileSystem....");
        GlusterDebugFileSystem.logMachine("init(" +  conf  + ")");
        super.setConf(conf);
    }
...
*/
    ...
    public boolean mkdirs(Path path) throws IOException{
        GlusterDebugFileSystem.logMachine("mkdirs("+path+")");
